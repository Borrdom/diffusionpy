...
volatile:xlo.Array(bool,dims=1),full_output:bool,Gammai:xlo.Array(float,dims=2)=None,w0II:xlo.Array(float,dims=1)=None):   
    return Diffusion_MS(t,L,Dvec,w0,w8,Mi,volatile,full_output,Gammai,w0II)
