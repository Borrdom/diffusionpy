...
class Mixture:
    ...
    def PCSAFT(self,psys=0.03166*1E5*0.5,T=298.15,na=""):
        ...
        rhoeq=6/cs.pi*eta*(cs.sum1(mi*xi*di**3))**-1 #mi*xi=phi*mbar und dann mbar*rho
        veq=1/rhoeq
        ...
        #self.lnfi=cs.log(xi*rhoeq*k*T)+mures
