...
def PCSAFTPVT(params,*args):
    ...
    return w2,PCSAFT(params,PVTx,*args)[2]
...
params['uij'].set(value=205,vary=0)
params['kij'].set(value=-0.146,vary=1)
params['mij'].set(value=0.04,vary=0)
params['sij'].set(value=2.7,vary=0)
params['p'].set(value=1,vary=0)
...
#params['kijS1'].set(value=-0.15,vary=0)
...
#    report_fit(result)
    ...
    return (PCSAFT(params,x,Sol,Pol,API)[0]*x2-data)
...
#w2ac,RHac=PCSAFTVLE(params,Sol,Pol)
