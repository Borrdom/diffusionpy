...
class Film:
    ...
    def Diffusion1D(self):
        ...
        if self.Mode=="MEOS":
            ...
            xvec,fvec,x0=self.Kris(jMS_fun,rho2II,rho2II_his,alpha,r,w2II,Time)
        elif self.Mode=="Diss":
    ...
    def Kris(self,jMS_fun,rho2II,rho2II_his,alpha,r,w2II,Time):
...
if __name__=="__main__":
    pure,kij,ksw=get_par(["pvpva64","water","pvpva64"])
    pol,sol,api=pure
    plt.close('all')
