...
def ExtractIsotherm(molecule1="pvpva64",molecule2="naproxen",RH=0.9,DL=0.68,T=25):
    cwd=getcwd()
...
if __name__=="__main__":
    wAPISIMraw,wwSIMraw=ExtractIsotherm(molecule1="pvpva64",molecule2="naproxen",RH=0.9,DL=0.68,T=25)
